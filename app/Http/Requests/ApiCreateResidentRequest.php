...
use App\Rules\RoomTypeOnly;

class ApiCreateResidentRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        $rules = [
            ...
            'resident_gender' => 'required|regex:/^[-+., M F]{1}$/',
            'location_room_id' => ['required', new RoomTypeOnly],
            'contact_name' => 'required',
            'contact_phone_num_1' => 'required',
            'contact_address' => 'required',
            'contact_relationship' => 'required|regex:/^[-+., S P C R O]{1}$/',
            'beacon_id' => [new IsUniqueTag(null)],
        ];
