...
class BasicTest extends TestCase
{
    ...
    public function testExample()
    {
        ...
        $gateway_id_1 = Reader::where('mac_addr', '111111111111')->get()[0]->id;
        $gateway_id_2 = Reader::where('mac_addr', '222222222222')->get()[0]->id;
        ...
        $attendance = Attendance_KLIA::where('tag_mac', 'AAAAAAAAAAAA')->orderBy('last_seen', 'desc')->get()[0];
