            ...
            <div class="modal-body" style="margin-left: -15px; margin-right: -15px; margin-top: -15px">
                <div class="container-fluid bd-example-row">
                    ...
                    <div class="row mt-3 justify-content-center mt-2">
                        <div class="h4 font-weight-bold" id="delete_location_text">Delete location?</div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="" id="delete_location_text_warning">You will not be able to recover it.</div>
                    </div>
                    <div class="row mt-5 justify-content-center">
                        <button type="button" class="btn btn-secondary m-1" id="cancel-btn" data-dismiss="modal">Cancel</button>
                        <button type="button" class="btn btn-danger m-1" id="delete-btn">Yes, delete</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#deleteLocationButton').on('click', function(){
        if (dTable.rows('.selected').data().length <= 0 ){
            ...
            if(dTable.rows('.selected').data().length == 1){
                ...
                $('#delete_location_text').html('Delete location?');
                $('#delete_location_text_warning').html('You will not be able to recover it');
                ...
                $('#delete-btn').css('background-color', 'var(--iq-danger)');
                $('#delete-btn').css('border-color', 'var(--iq-danger)');
                $('#delete_location_text').html('Delete locations?');
                $('#delete_location_text_warning').html('You will not be able to recover them');
                $('#confirmation-modal').modal('toggle');
            }
        }
    });
